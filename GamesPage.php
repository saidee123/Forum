...
<section>
	<header>
		<h1>Games section</h1><br>
		<h2>This is where you can discuss anything related to games. Rise up gamers </h2> <br>
	</header>
	  ...
	  <input type="hidden" style="display:none;" name="post_board" value="game" >
	...
	<main>
			   ...
			   <?php
					...
					$conn = new mysqli($host, $dbUsername, $dbPassword, $dbname);
					 ...
					 $sql = "SELECT post_id,post_title, date, original_poster FROM thread WHERE post_board = 'game' AND sticky = 'yes' ORDER BY post_id DESC" ;
