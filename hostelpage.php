...
<img class ="logo" src="mmulogo.png" alt="MMU Logo" width="108" height="80">
 ...
 <div class="login" >
  ...
  <img class="boardpic" src="hostel.png" alt="hostel logo" width="138" height="130">
  <h1>Hostel</h1>
  <h2>This is where you can discuss anything related to hostel.</h2> <br>
   ...
   <label>Create a new topic</label><p>
	  ...
	  <input type="text" style="display:none;" name="username" value=<?php echo $username?> >
	  	...
	  	<input type="hidden" style="display:none;" name="post_board" value="hostel" >
...
$conn = new mysqli($host, $dbUsername, $dbPassword, $dbname);
 ...
 $sql = "SELECT post_id,post_title, date, original_poster FROM thread WHERE post_board = 'hostel' AND sticky = 'yes' ORDER BY post_id DESC" ;
