...
body{background-color:#ffe9d4;}
h1{padding: 0px 0px 0px 470px; color:#eb4034;}	
h2{padding: 0px 0px 0px 470px;}
   </style>
</head>
<script>
...
<img class ="logo" src="mmulogo.png" alt="MMU Logo" width="108" height="80">
 ...
 <div class="login" >
  ...
  <img class="boardpic" src="qa.png" alt="qa logo" width="158" height="150">
  <h1>Question&Answer</h1>
  <h2>Looking for answer? Ask here.</h2> <br>
   ...
   <label>Create a new topic</label><p>
	  ...
	  <input type="text" style="display:none;" name="username" value=<?php echo $username?> >
	  	...
	  	<input type="hidden" style="display:none;" name="post_board" value="qa" >
...
$conn = new mysqli($host, $dbUsername, $dbPassword, $dbname);
 ...
 $sql = "SELECT post_id,post_title, date, original_poster FROM thread WHERE post_board = 'qa' AND sticky = 'yes' ORDER BY post_id DESC" ;
