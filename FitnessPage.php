...
<head lang="en">
   ...
   <link rel="stylesheet" href="FitnessPage.css" />
   <style>
...
<section>
	<header>
		<h1>Fitness section</h1><br>
		<h2>This is where you can discuss anything related to fitness. Healthy lifestyle is the way. </h2> <br>
	</header>
      ...
      <textarea name="post_text" rows="10" cols="75" placeholder="Enter content here" required></textarea><p>
	  ...
	  <input type="hidden" style="display:none;" name="post_board" value="fitness" >
	...
	<main>
			   <?php
					...
					$conn = new mysqli($host, $dbUsername, $dbPassword, $dbname);
					 ...
					 $sql = "SELECT post_id,post_title, date, original_poster FROM thread WHERE post_board = 'fitness' AND sticky = 'yes' ORDER BY post_id DESC" ;
