...
h1{padding: 0px 0px 0px 520px; color:#475f96;}	
h2{padding: 0px 0px 0px 420px;}
   </style>
</head>
<script>
...
<img class ="logo" src="mmulogo.png" alt="MMU Logo" width="108" height="80">
 ...
 <div class="login" >
  ...
  <img class="boardpic" src="multimedia.png" alt="qa logo" width="158" height="150">
  <h1>Multimedia</h1>
  <h2>Anything related to multimedia can be discussed here</h2> <br>
   ...
   <label>Create a new topic</label><p>
	  ...
	  <input type="text" style="display:none;" name="username" value=<?php echo $username?> >
	  	...
	  	<input type="hidden" style="display:none;" name="post_board" value="multi" >
...
$conn = new mysqli($host, $dbUsername, $dbPassword, $dbname);
 ...
 $sql = "SELECT post_id,post_title, date, original_poster FROM thread WHERE post_board = 'multi' AND sticky = 'yes' ORDER BY post_id DESC" ;
